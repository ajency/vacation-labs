...
// Added by Saurabh Nanda to support bottom border setting
function bottom_border_class($section) {
    return (get_post_meta($section, 'ag_bottom_border', true)=='Yes' ? ' with-bottom-border ' : '');
}
	...
	$section_post = get_post($section); 
		...
		switch ($ag_section['section_layout']) {
			case('Left') : ?>        
                ...
                echo bottom_border_class($section);
                echo ' ' . get_post_meta($section, 'ag_custom_css_classes', true) . ' ';
